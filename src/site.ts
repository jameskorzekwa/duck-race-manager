...
@media (max-width:43.99rem) { .shell { width:min(100% - 1rem,40rem); } .site-head { flex-wrap:wrap; gap:var(--space-sm); padding:var(--space-sm) 0; } .nav { width:100%; } .nav a { flex:1 1 0; padding:.7rem .45rem; text-align:center; } .nav a:first-child { display:none; } .hero { min-height:0; padding:1.5rem 1.5rem 17rem; border-radius:1.35rem; box-shadow:6px 6px 0 var(--ink); } .hero h1 { font-size:clamp(1.7rem,8.9vw,2.3rem); } .cards { margin:var(--space-lg) 0 2rem; } .card,.duck-card,.operation-card,.console-section { padding:var(--space-md); } .status-section { margin:var(--space-lg) 0 2rem; padding:var(--space-md); } .page-panel { margin:var(--space-sm) auto var(--space-lg); padding:var(--space-md); border-radius:1rem; box-shadow:5px 5px 0 var(--ink); } .participant-section { margin:var(--space-lg) 0; padding-top:var(--space-lg); } .notice,.privacy,.emergency-warning { padding:var(--space-md); } .actions { position:relative; z-index:4; justify-content:center; gap:var(--space-sm); } .participant-section-head-actions,.carousel-controls,.section-tools,.inventory-detail-heading,.staff-role-controls,.roster-entry .actions,.data-card .actions { justify-content:flex-start; } form > .button,.operation-card > .button,.console-section > .button,.page-panel > .button { display:flex; width:100%; max-width:24rem; margin-inline:auto; } .pairing-confirmation > .button { display:flex; width:100%; max-width:20rem; margin-inline:auto; } .app-confirmation { width:calc(100% - 1rem); max-height:calc(100vh - 1rem); padding:var(--space-md); } .app-confirmation-actions,.app-date-actions { justify-content:center; } .button.small { min-height:2.75rem; } .hero-duck-scene { --duck-center:50%; right:50%; bottom:4rem; width:13.5rem; } .hero-duck { --duck-lift:-.75rem; } .hero-water { height:11rem; } .ticker { font-size:.7rem; } .page-panel > .duck-mark { width:5.7rem; } .privacy { display:block; } .privacy strong { display:block; margin-bottom:.25rem; } .participant-card { flex-basis:calc(100% - 2.25rem); } .participant-section-head-actions { flex-basis:100%; justify-content:flex-start; } .search-form { grid-template-columns:1fr; } .app-date-panel { position:fixed; top:1rem; right:1rem; left:1rem; width:auto; max-height:calc(100vh - 2rem); } .staff-bar { align-items:flex-start; } .staff-access-card .actions { width:100%; } .role-set > .check { min-height:2.75rem; } .staff-role-controls .button { flex:1 1 8rem; } .site-foot { padding:var(--space-lg) 0 2rem; } }
