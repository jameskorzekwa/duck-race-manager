...
const pairDuck = async (
  ...
  const assignmentNotifications = assignedHeatId === null
    ? { ids: [], statements: [] }
  ...
  statements.push(...assignmentNotifications.statements);
  ...
  await publishParticipantNotifications(env, assignmentNotifications.ids);
